// this will do some configuration
let { Sequelize, DataTypes } = require('sequelize')

// environment variables are variables a computer stores
let env = process.env.NODE_ENV || 'development' // set a default if there is no environment variable 
...
let studentModelCreate = require('./student') // a function call
